    ...
    return (
        <Container >
            <Container>
                ...
                <p>Además de mi dedicación a la programación, también poseo una habilidad innata para la resolución de conflictos. Mi enfoque pragmático y mi capacidad para ver las situaciones desde múltiples perspectivas me permiten encontrar soluciones que beneficien a todas las partes involucradas.</p>
