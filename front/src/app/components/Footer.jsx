        ...
        <Container className="bg-secondary container-xl">
            <Row className="mt-4">
                <Col className="d-flex my-4 justify-content-center align-items-center" xs={12} md={3}>
                    <Link href="https://wa.me/523310401077?text=Gracias%20por%20ponerte%20en%20contacto%20conmigo.%20En%20cuanto%20me%20sea%20posible%20respondere%20a%20tu%20mensaje." className="btn btn-info text-dark d-flex g-2 align-items-center p-2" target="_blank">
